...
// Cone.cs
//
// Copyright (C) Scott Johnson. All rights reserved.
//-----------------------------------------------------------------------------
#endregion
...
{
   /// <summary>
    ///  A procedurally created cone.  Lets you specify the length, radius and vertex count around the base.  
    ///  It is a length because it points along X.  It doesn't currently have a polygon for the base of the cone.
    /// </summary>
    public class Cone
    {

    ...
    public class GraphicsDeviceControl : HwndHost
    {
        ...
        void XnaWindowHost_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            if (graphicsService == null)
            {
                ...
                // sjohnson - following along web site
                // http://blogs.msdn.com/b/nicgrave/archive/2011/03/25/wpf-hosting-for-xna-game-studio-4-0.aspx
                // "Also, don't forget to add the service to the service container in the XnaWindowHost_Loaded event:"
                // Plus, the WinFormsContentLoading example does the same thing in the same place.
            ...
            switch (msg)
            {
                ...
                case NativeMethods.WM_MOUSEMOVE:
                    ...
                    if (!mouseInWindow)
                    {
                        ...
                        // Customization from (below) that allows mouse wheel message to work
                        // https://github.com/BinaryConstruct/BCCL/blob/master/BCCL.Xna/UI/Xaml/XnaContentHost/GraphicsDeviceControl.cs
